...
Maybe you have also heard about *Finite State Machines (FSM)*? Have you googled "state machines" before? FSMs will be all over the place. This is what it looks like:

![state machines google search](./images/K8F9JoCmB.png)
...
![state machines as part of automata theory](./images/khx5SInlYp.jpeg)
...
![state machine example](./images/X1wpLZ9Ix.png)
...
![state machine mathematical model](./images/oGAPOoD6C.png)
...
![statechart example](./images/o1JdyQ0RP.png)
