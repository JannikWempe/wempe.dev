...
not an issue at all but it can get out of control if a lot of components and their children re-render.)_

_Note: There are ways to combine context with other techniques like subscriptions to mitigate this issue. But here I am
referring to using plain context + `useState` / `useReducer`._
