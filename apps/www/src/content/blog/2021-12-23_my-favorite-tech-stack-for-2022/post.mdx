...
cover: './images/htRMAs7k4.png'
tags: ['personal', 'svelte', 'reactjs', 'nextjs', 'tailwind', 'aws']
excerpt: >-
...
I just recently tweeted my favorite tech stack for 2022 (inspired by @[Jon Meyers](https://x.com/jonmeyers_io) tweet). I'd like to share some more thoughts about my choices in this post.

<Tweet id="https://x.com/JannikWempe/status/1473935933447839748" />
...
This blog post goes into detail [Why Svelte is different - and awesome](https://wempe.dev/blog/why-svelte-is-different-and-awesome). I just really enjoy using Svelte. It is more concise than React and more performant. Stores and animations are also great features. There is a reason why Svelte was the [most loved web framework in the Stack Overflow Developer Survey 2021](https://insights.stackoverflow.com/survey/2021#section-most-loved-dreaded-and-wanted-web-frameworks).
...
I love styling with utilities based on a predefined and easily customizable theme. If you have read my post [Debunking Tailwind Counterarguments](https://wempe.dev/blog/debunking-tailwind-counterarguments) you already know that I am a big fan. Most often I use [Headless UI](https://headlessui.dev/) as an addition to get some functionality like a select or a modal. I've also bought [Tailwind UI](https://tailwindui.com/) in order to move faster and also for some inspiration — and I don't regret it.
