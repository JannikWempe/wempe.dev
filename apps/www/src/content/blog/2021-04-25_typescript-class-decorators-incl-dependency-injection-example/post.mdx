...
function classDecorator <T extends Constructor>(constructor: T): T | void {
  ...
  return class extends constructor {} // extends works
}
...
// add to class which has constructor parameters marked with @inject()
...
class UserService {
  ...
  // an instance of the UserRepository class, identified by key 'UserRepository' should be injected
