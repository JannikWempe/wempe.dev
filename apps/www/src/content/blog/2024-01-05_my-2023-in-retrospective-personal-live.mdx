...
Shortly after that vacation I again sat in a train to Munich to **visit [Sandro](https://sandrovolpicella.com/)**. We went to the the **AWS Community Day** which was awesome. So many interesting talks and we met even more interesting folks. I can highly recommend it. After it we met @[Ronald Blüthl](@rbluethl) again for a **hike**. (It is sad that there are basically no mountains in northern Germany).
