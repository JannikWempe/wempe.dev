...
*Note: Even though a lot of people are talking about "(no) runtime", it should more accurately be "(no) runtime **system**".*
...
![image.png](./images/Olvdi5zOk.png)
...
![image.png](./images/accrTZHyr.png)
...
![animations.gif](./images/hS_6eOg5V.gif)
