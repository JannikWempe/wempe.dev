...
// MethodDecorator also applies for accessor decorators (getter/setter)
...
//   [LOG]: "parameterDecorator",  "calculateArea",  0
//   [LOG]: "methodDecorator",  "calculateArea"
