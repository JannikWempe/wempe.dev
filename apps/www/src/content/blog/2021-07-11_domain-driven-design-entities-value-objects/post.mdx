...
is omitted as it isn't really required to prove my point later on):
...
**If the answer is yes, it is an Entity.** Entities allow keeping track of information over time. Whereas VOs are like a
