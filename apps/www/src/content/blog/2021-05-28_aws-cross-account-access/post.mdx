...
```json
{
  "Effect": "Allow",
  "Action": "sts:AssumeRole",
  "Resource": "arn:aws:iam::999999999999:role/MyTableCrossAccount"
}
```
...
You can define ACLs under the `Permissions` tab by clicking on `Edit` in the `Access control list (ACL)` section. This is what it looks like:
